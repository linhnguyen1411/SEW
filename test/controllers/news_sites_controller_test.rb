...
class NewsSitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create news_site" do
    assert_difference('NewsSite.count') do
      post news_sites_url, params: { news_site: { name: @news_site.name, rating: @news_site.rating, url: @news_site.url } }
    end
  ...
  test "should update news_site" do
    patch news_site_url(@news_site), params: { news_site: { name: @news_site.name, rating: @news_site.rating, url: @news_site.url } }
